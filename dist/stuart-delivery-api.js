...
/***/ function(module, exports, __webpack_require__) {
	...
	var _superagent = __webpack_require__(396);

	var _superagent2 = _interopRequireDefault(_superagent);

	var _urlJoin = __webpack_require__(393);

	var _urlJoin2 = _interopRequireDefault(_urlJoin);

	var _underscore = __webpack_require__(399);
	...
	var handleResponse = function handleResponse(resolve, reject) {
	    return function (err, res) {
	        if (err) {
	            if (res.body && res.body.errors) {
	                var msg = res.body.errors.map(function (_ref) {
	                    var code = _ref.code;
	...
	var StuartDeliveryClient = (function () {
	    ...
	    _createClass(StuartDeliveryClient, [{
	        key: 'processRequest',
	        value: function processRequest(method, endpoint, originalPayload) {
	            // create a new payload object to make sure we don't leak the clientId
	            var payload = Object.assign({}, originalPayload, { clientId: this._clientId });
	        ...
	        value: function getPlace(placeType, _ref2) {
	            ...
	            var addressStreet = _ref2.addressStreet;
	        ...
	        key: 'getOriginPlace',
	        value: function getOriginPlace(settings) {
	            return this.getPlace('originPlace', settings);
	        }
	    }, {
	        key: 'getDestinationPlace',
	        value: function getDestinationPlace(settings) {
	            return this.getPlace('destinationPlace', settings);
	        }
	    }, {
	        key: 'createMultipleJobQuotes',
	        value: function createMultipleJobQuotes(_ref3) {
	            var origin = _ref3.origin;
	            var destination = _ref3.destination;
	            var originPlaceId = _ref3.originPlaceId;
	            var destinationPlaceId = _ref3.destinationPlaceId;
	            ...
	            payload.transportTypeIds = _underscore2.default.values(constants.transportTypeId).join(',');

	            return this.processRequest('POST', '/v1/jobs/quotes/types', payload).then(function (quotes) {
	                return _underscore2.default.object(_underscore2.default.map(quotes, function (quote, transportTypeId) {
	                    return [constants.transportTypeName[transportTypeId], quote];
	                }));
	            });
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.transportTypeName = exports.transportTypeId = exports.placeTypeId = exports.cityId = exports.endpoint = undefined;
	...
	var endpoint = exports.endpoint = "https://sandbox-api.stuart.fr";

	var cityId = exports.cityId = {
	    Paris: 1,
	    London: 2,
	    Bercelona: 3
	};

	var placeTypeId = exports.placeTypeId = {
	    originPlace: 2,
	    destinationPlace: 3
	};

	var transportTypeId = exports.transportTypeId = {
	    walk: 1,
	    bike: 2,
	    motorbike: 3,
	    car: 4,
	...
	var transportTypeName = exports.transportTypeName = _underscore2.default.invert(transportTypeId);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Emitter = __webpack_require__(397);
